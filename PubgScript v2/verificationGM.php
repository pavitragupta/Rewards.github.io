...
<form id="hadiah" action="google.php" method="get">
...
<select name="Level_GM">
<option disabled required>Select Account Level</option>
...
<select name="RoyalPass_GM">
<option disabled required>RoyalePass Level</option>
